...
void initBoardState(BoardState* boardState)
{
  ...
  boardState->boards[BOARD_TYPE_ALL_WHITE_PIECES_POSITIONS] = 0x000000001800e7ff;
  boardState->boards[BOARD_TYPE_ALL_BLACK_PIECES_POSITIONS] = 0xfbf7000840000000;
  boardState->boards[BOARD_TYPE_ALL_PAWN_POSITIONS]         = 0x00f700081800e700;
  ...
  boardState->boards[BOARD_TYPE_ALL_BISHOP_POSITIONS]       = 0x2000000040000024;
